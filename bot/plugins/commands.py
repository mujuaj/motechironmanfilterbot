...
async def start(bot, update):
    ...
    if file_uid:
        ...
        if file_type == "document":
            ...
            await bot.send_document(
                ...
                document = file_id,
                caption = f" <b>Join <a href="https://t.me/worldmoviesaj">MOVIE HUB HD⬛️◼️◾️▪️</a> </b> \n <code>{file_name}</code> \n <b> <a href="https://t.me/AJmovieLINKS ">𝘼𝙇𝙇 𝙈𝙊𝙑𝙄𝙀𝙎 𝘼𝙉𝘿 𝙎𝙀𝙍𝙄𝙀𝙎 𝙃𝘿</a></b> \n <b>© Powered by <a href="https://t.me/AJmovieLINKS ">𝚈𝙾𝚄 𝚁𝙴𝚀𝚄𝙴𝚂𝚃 𝚆𝙴 𝙿𝚁𝙾𝚅𝙸𝙳𝙴</a></b>",
                parse_mode="html",
                    ...
                    [
                        [
                            InlineKeyboardButton
                                (
                                    '🔔Join Main Channel🔔', url="https://t.me/AJmovieLINKS"
                                )
                        ],
                        [
                            InlineKeyboardButton
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton
                                (
                                    '👨‍💼 𝙳𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚛𝚜 👨‍💼', url="https://t.me/worldmoviesaj"
                                )
                        ]
                    ]
                )
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton
                                (
                                    '👨‍💼 𝙳𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚛𝚜 👨‍💼', url="https://t.me/AJmovieLINKS"
                                )
                        ]
                    ]
                )
    ...
    buttons = [[
        InlineKeyboardButton('👨‍💼Creator', url=f'https://t.me/avataradorn'),
        InlineKeyboardButton('Help 🤔', callback_data="help")
    ],[
        InlineKeyboardButton('🗣️Group', url=f'https://t.me/AJmovieLINKS'),
        InlineKeyboardButton('MORE MOVIES', url=f'https://t.me/worldmoviesaj')
    ],[
        InlineKeyboardButton('ALL MOVIES', url='https://t.me/AJmovieLINKS')
    ]]
